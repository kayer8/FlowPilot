...
test('step 8 uses a fixed 10-minute lookback window and plans 2925 polling as 3/3/3', async () => {
  ...
  assert.equal(capturedOptions.initialPollMaxAttempts, 3);
  assert.deepStrictEqual(capturedOptions.pollAttemptPlan, [3, 3, 3]);
